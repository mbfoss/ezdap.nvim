...
---@class easydap.tk.fixedwin.AxisSpec
...
---@type table<string, easydap.tk.fixedwin.AxisSpec>
local _AXES = {
    height = {
        split = "split",
        fix   = "winfixheight",
...
---@class easydap.tk.fixedwin.Opts
...
---@param opts? easydap.tk.fixedwin.Opts
