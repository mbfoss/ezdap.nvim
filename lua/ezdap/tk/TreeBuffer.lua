...
local uiutil = require("ezdap.tk.ui")
local Signal = require("ezdap.tk.Signal")

---@class ezdap.tk.TreeBuffer.Item
---@field id any
---@field data any
---@field expandable boolean
---@field expanded boolean

---@class ezdap.tk.TreeBuffer.ItemDef
---@field id any
---@field data any
---@field expandable boolean?
---@field expanded boolean?

---@class ezdap.tk.TreeBuffer.ItemData
---@field userdata any
---@field expandable boolean?
---@field expanded boolean?

---@alias ezdap.tk.TreeBuffer.FormatterFn fun(id:any, data:any, expanded:boolean):string[][], string[][], string?

---@class ezdap.tk.TreeBuffer.Opts
---@field filetype string?
---@field formatter ezdap.tk.TreeBuffer.FormatterFn
...
---@class ezdap.tk.TreeBuffer
---@field private _filetype string?
---@field private _formatter ezdap.tk.TreeBuffer.FormatterFn
...
---@param opts ezdap.tk.TreeBuffer.Opts
---@return ezdap.tk.TreeBuffer
...
---@param item ezdap.tk.TreeBuffer.ItemDef
---@return ezdap.tk.TreeBuffer.ItemData
local function _to_itemdata(item)
    return { userdata = item.data, expandable = item.expandable, expanded = item.expanded }
end

---@param id any
---@param data ezdap.tk.TreeBuffer.ItemData
---@return ezdap.tk.TreeBuffer.Item
...
---@private
---@return any?, ezdap.tk.TreeBuffer.ItemData?
...
---@param children ezdap.tk.TreeBuffer.ItemDef[]
---@return boolean
