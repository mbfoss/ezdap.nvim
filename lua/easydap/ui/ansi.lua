...
---@return easydap.ui.ansi.State
function M.new_state()
    return {}
end

---@param state easydap.ui.ansi.State
...
---@param text string
---@return string clean
---@return easydap.ui.ansi.Span[] spans
