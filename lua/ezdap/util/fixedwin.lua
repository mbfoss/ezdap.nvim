...
---@type table<string, ezdap.util.fixedwin.AxisSpec>
local _AXES = {
    height = {
        split = "split",
        fix   = "winfixheight",
...
---@class ezdap.util.fixedwin.Opts
...
---@param opts? ezdap.util.fixedwin.Opts
...
function M.create_fixed_win(axis, ratio, on_delete, opts)
    ...
    local active = spec ---@type ezdap.util.fixedwin.AxisSpec?

    ---@param s ezdap.util.fixedwin.AxisSpec
    ---@param r number
    ---@return integer
