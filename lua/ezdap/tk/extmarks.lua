...
---@class ezdap.tk.extmarks.MarkInfo
---@field id number
---@field file string
...
---@class ezdap.tk.extmarks.MarkData
---@field id number
---@field ns number
---@field lnum number        -- 1-based
---@field col number        -- 0-based
...
---@alias ezdap.tk.extmarks.ById table<number, ezdap.tk.extmarks.MarkData>
---@alias ezdap.tk.extmarks.ByFile table<string, ezdap.tk.extmarks.ById>

---@class ezdap.tk.extmarks.GroupData
---@field ns number
---@field byfile ezdap.tk.extmarks.ByFile
---@field id_to_file table<number, string>

---@class ezdap.tk.extmarks.GroupInfo
---@field priority number
---@field data ezdap.tk.extmarks.GroupData

---@type table<string, ezdap.tk.extmarks.GroupInfo>
...
---@param bufnr integer
---@param mark ezdap.tk.extmarks.MarkData
...
---@param group_info ezdap.tk.extmarks.GroupInfo
...
local function _set_file_extmark(id, file, lnum, col, group_info, opts, user_data)
    ...
    ---@type ezdap.tk.extmarks.MarkData
    local mark = {
        id = id,
        ns = group_data.ns,
        lnum = lnum,
...
---@param id number
---@param group_info ezdap.tk.extmarks.GroupInfo
---@return ezdap.tk.extmarks.MarkInfo?
...
---@class ezdap.tk.extmarks.GroupFunctions
...
---@field get_extmark_by_id fun(id:number): ezdap.tk.extmarks.MarkInfo?
---@field get_extmark_by_location fun(file:string, line:number, live:boolean): ezdap.tk.extmarks.MarkInfo?
---@field get_extmarks fun(live:boolean): ezdap.tk.extmarks.MarkInfo[]
---@field get_file_extmarks fun(file:string, live:boolean): ezdap.tk.extmarks.MarkInfo[]
---@field refresh fun()
...
---@return ezdap.tk.extmarks.GroupFunctions
function M.define_group(group, group_opts)
    ...
    ---@type ezdap.tk.extmarks.GroupInfo
    local group_info = {
    ...
    ---@type ezdap.tk.extmarks.GroupFunctions
    return {
