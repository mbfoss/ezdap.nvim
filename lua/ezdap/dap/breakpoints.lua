...
---bound line, hit count) is session-scoped (see ezdap.dap.BpStatus) and is
...
---@class ezdap.dap.FunctionBreakpoint
---@field internal_id integer
---@field name        string
---@field disabled    boolean

---@class ezdap.dap.ExceptionBreakpoint
---@field filter   string
---@field label    string
---@field default  boolean
---@field disabled boolean

---@class ezdap.dap.ExceptionFilterDef
---@field filter  string
---@field label   string
---@field default boolean?

---@alias ezdap.dap.ExceptionBreakMode "never"|"always"|"unhandled"|"userUnhandled"

---@class ezdap.dap.ExceptionNameBreakpoint
---@field internal_id integer
---@field name        string
---@field break_mode  ezdap.dap.ExceptionBreakMode
---@field disabled    boolean

---@class ezdap.dap.BreakpointData
...
---@alias ezdap.dap.BreakpointChangeKind "source" | "function" | "exception_filter" | "exception_type" | "restore"
...
---@type ezdap.dap.SourceBreakpoint[]
local _source_bps = {}
---@type ezdap.dap.FunctionBreakpoint[]
local _function_bps = {}
---@type ezdap.dap.ExceptionBreakpoint[]
local _exception_bps = {}
---@type ezdap.dap.ExceptionNameBreakpoint[]
...
---@return ezdap.dap.FunctionBreakpoint?
...
---@return ezdap.dap.ExceptionBreakpoint[]
...
---@return ezdap.dap.ExceptionNameBreakpoint?
...
---@param name       string
---@param break_mode ezdap.dap.ExceptionBreakMode?
---@return ezdap.dap.ExceptionNameBreakpoint?
...
---@class ezdap.dap.BreakpointPosition
...
---@return ezdap.dap.BreakpointData
function M.get_data()
    local sources = {}
    for _, bp in ipairs(_source_bps) do
        sources[#sources + 1] = {
...
---@param data ezdap.dap.BreakpointData?
