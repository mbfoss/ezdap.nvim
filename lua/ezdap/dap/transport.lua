...
---@class ezdap.dap.Parser
---@field buf        string        accumulated raw bytes
---@field on_message fun(msg: ezdap.dap.Message)  called for each complete decoded message
---@field feed       fun(self: ezdap.dap.Parser, chunk: string)
...
---@return ezdap.dap.Parser
function M.new_parser()
    ---@type ezdap.dap.Parser
