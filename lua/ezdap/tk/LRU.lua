---@class ezdap.tk.LRU.Node
---@field key any
---@field value any
---@field prev ezdap.tk.LRU.Node?
---@field next ezdap.tk.LRU.Node?

---@class ezdap.tk.LRU
---@field _capacity integer
---@field _count integer
---@field _map table<any, ezdap.tk.LRU.Node>
---@field _head ezdap.tk.LRU.Node?
---@field _tail ezdap.tk.LRU.Node?
...
---@field new fun(self:ezdap.tk.LRU, capacity:integer, opts?:{on_evict?:fun(key:any, value:any), on_removed?:fun(key:any, value:any)}):ezdap.tk.LRU
local LRU = {}
LRU.__index = LRU
