...
---@alias ezdap.tk.SpinnerOpts {frames?:string[], interval?:integer, on_update?:fun(frame:string, index:integer)}

---@class ezdap.tk.Spinner
---@field new fun(self:ezdap.tk.Spinner,opts:ezdap.tk.SpinnerOpts):ezdap.tk.Spinner
local Spinner = {}
...
---@param opts ezdap.tk.SpinnerOpts?
