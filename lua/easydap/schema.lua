...
---`profiles` (named `easydap.Profile` entries, in `easydap.adapters`)
...
---@return table<string, easydap.Profile>
...
---The inputs a profile declares (`name -> easydap.Input`), or an empty table.
