...
---@field private _compl    ezdap.ReplBuffer.ComplState
local ReplBuffer = {}
ReplBuffer.__index = ReplBuffer

---@class ezdap.ReplBuffer.ComplState
...
---@param opts ezdap.ReplBuffer.Opts
---@return ezdap.ReplBuffer
function ReplBuffer.new(opts)
    ---@type ezdap.ReplBuffer.ComplState
